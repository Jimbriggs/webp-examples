...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><HTML><!-- InstanceBegin template="/Templates/SUMS basic JSP.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
<HEAD>
...
</logic:notPresent><!-- #EndLibraryItem --><!-- InstanceEndEditable --><!-- InstanceBeginEditable name="body" --><!-- #BeginLibraryItem "/Library/Errors and messages.lbi" -->
...
<p><bean:write name="error"/></p>
</html:messages><!-- #EndLibraryItem --><!-- #EndLibraryItem --><TABLE border="0" cellspacing="0" cellpadding="0">
        <TR valign="top">
        <TD>
        <FORM action="j_security_check" method="POST">
            ...
            <TD><H3>Not yet a user? </H3>
            <P><html:link forward="regForm">Register here</html:link> </P></TD>
        </TR>
    </TABLE>
    <!-- InstanceEndEditable -->
