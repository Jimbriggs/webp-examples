...
ERROR: Application resources not loaded -- check servlet container logs for error messages.
        ...
        <h1>My contacts</h1>
        <html:errors/>
        <html:errors name="messages"/>
        <table>
            <logic:present name="myContacts">
                <logic:iterate id="contact" name="myContacts">
                    <TR>
                    <TD><bean:write name="contact" property="orgname"/>
                    (<bean:write name="contact" property="orgcontact"/>)
                    <html:link action="/EditContact" paramId="contact" paramName="contact" paramProperty="orgid">
                    
                        [Edit]
                    </html:link>
                    <html:link action="/ListIdeas" paramId="contact" paramName="contact" paramProperty="orgid">
                    [List ideas from this contact]
                    </html:link>
                </logic:iterate>
            </logic:present>
            <logic:notPresent name="myContacts">
                <P>No contacts
            </logic:notPresent>
        </table>
    <!-- InstanceEndEditable -->
