...
public abstract class MessageController implements Serializable {
    ...
    protected void addError(String item, String s) {
        getFacesContext().addMessage(item, new FacesMessage(FacesMessage.SEVERITY_ERROR, s, s));
    }

    protected void addInfo(String item, String s) {
        getFacesContext().addMessage(item, new FacesMessage(FacesMessage.SEVERITY_INFO, s, s));
    }
