...
<tiles:insert page="../tiles/layout.jsp" flush="true">
        ...
        <tiles:put name="title" type="string">
            ...
            <bean:message key="pums.assess.titles.moderator"/>
        
        </tiles:put>

    <tiles:put name="body" type="string">   
    
            <p>Please select a member of staff to assign as moderator</p>

            <html:form action="/assess/moderatorAssign" method="post">
