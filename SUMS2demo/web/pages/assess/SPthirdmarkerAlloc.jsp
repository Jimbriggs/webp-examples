...
<tiles:insert page="../tiles/layout.jsp" flush="true">
        ...
        <tiles:put name="title" type="string">
            ...
            <bean:message key="pums.assess.titles.3rdmarker"/>
        
        </tiles:put>

    <tiles:put name="body" type="string">   
    
            <p>Please select a member of staff to assign as 3rd marker</p>

            <html:form action="/assess/thirdMarkerAssign" method="post">
            <table width="1024" cellspacing="2" cellpadding="5">
            <tr>
            <th width="33%" class="tableHead">3rd Marker:</th>
