...
<tiles:insert page="../tiles/layout.jsp" flush="true">
        ...
        <tiles:put name="title" type="string">
            ...
            <bean:message key="pums.assess.titles.examinermarker"/>
        
        </tiles:put>

    <tiles:put name="body" type="string">   
    
            <p>Please select a member of staff to assign as the examiner marker</p>

            <html:form action="/assess/examinerMarkerAssign" method="post">
            <table width="1024" cellspacing="2" cellpadding="5">
            <tr>
            <th width="33%" class="tableHead">Examiner Marker:</th>
