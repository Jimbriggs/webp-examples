...
/**
 * Generates a form for marker (re)assignment
 * @author Steve Powell
 */
public class MarkerAssign extends PumsBaseAction {
    ...
    public ActionForward doPumsExecute(StrutsUtils su) throws IOException, ServletException, JimFatalException {
        try {
            ...
            throw new JimFatalException("Cannot get staff dropdowns - database problem", e);
        }
